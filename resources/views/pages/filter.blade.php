...
@endforeach
                                            ...
                                            data-original-title="<span class=film-title>{{ $movie->name }}</span>">
                                        </div>
                ...
                <div class="clearfix"></div>
                <div class="text-center">
                    {{ $listMovies->links('vendor.pagination.custom') }}
                </div>
            </section>
        </main>
