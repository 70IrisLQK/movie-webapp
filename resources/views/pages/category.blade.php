                    ...
                    <div class="col-xs-8 hidden-xs">
                        <nav aria-label="breadcrumbs" class="rank-math-breadcrumb">
                            <p><a href="{{ url('/') }}">Trang chủ</a><span class="separator"> » </span><span
                                    class="last">{{ $listCategoryBySlug->name }}</span></p>
                        </nav>
                    </div>
            ...
            <section>
                <div class="section-bar clearfix">
                    <h3 class="section-title">
                        <span>Danh sách phim {{ $listCategoryBySlug->name }}</span>
                    </h3>
                </div>
                <div class="halim_box">
                    @foreach ($listMovieByCategory as $movie)
...
@endforeach
                ...
                <div class="clearfix"></div>
                <div class="text-center">
                    {{ $listMovieByCategory->links('vendor.pagination.custom') }}
                </div>
            </section>
        </main>
